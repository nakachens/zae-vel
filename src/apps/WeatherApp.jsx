...
const styles = {
  ...
  characterPlaceholder: {
    ...
    maxWidth: '400px', 
    maxHeight: '240px', 
    background: 'linear-gradient(45deg, #3E2B27, #8B2A2A)',
    ...
    boxShadow: '0 4px 8px rgba(30, 26, 25, 0.3)',
  },
  ...
  searchButton: {
    ...
    fontWeight: '600',
    transition: 'all 0.2s ease',
    boxShadow: '0 2px 4px rgba(30, 26, 25, 0.2)',
  },
  suggestions: {
    position: 'absolute',
    top: '100%',
    ...
    overflowY: 'auto',
    zIndex: 1000,
    boxShadow: '0 4px 8px rgba(139, 42, 42, 0.2)',
  },
  suggestionItem: {
    padding: '10px 12px',
    cursor: 'pointer',
    fontSize: '12px',
    borderBottom: '1px solid #A3B1A2',
    color: '#1E1A19',
    fontWeight: '400',
  ...
  tvFrame: {
    ...
    maxHeight: '360px',
    background: '#3E2B27',
    border: '8px solid #1E1A19',
    borderRadius: '12px',
    position: 'relative',
    boxShadow: 'inset 0 0 20px rgba(0,0,0,0.8), 0 8px 20px rgba(139, 42, 42, 0.3)',
  },
  tvScreen: {
    width: 'calc(100% - 10px)',
    ...
    position: 'relative',
    overflow: 'hidden',
    boxShadow: 'inset 0 0 15px rgba(30, 26, 25, 0.2)',
  },
  clock: {
    position: 'absolute',
    top: '15px',
    ...
    textAlign: 'center',
    zIndex: 10,
    boxShadow: '0 2px 4px rgba(139, 42, 42, 0.3)',
  },
  weatherContent: {
    width: '50%',
    height: '100%',
  ...
  characterArea: {
    ...
    width: '50%',
    height: '100%',
    background: 'linear-gradient(45deg, #C6C1B5, #A3B1A2)',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    color: '#1E1A19',
    fontSize: '12px',
    borderLeft: '2px solid #8B2A2A',
  },
  detailsButton: {
    position: 'absolute',
    bottom: '15px',
    ...
    fontWeight: '500',
    transition: 'all 0.2s ease',
    boxShadow: '0 2px 4px rgba(30, 26, 25, 0.3)',
  },
  backButton: {
    position: 'absolute',
    bottom: '15px',
  ...
  popup: {
    ...
    lineHeight: 1.6,
    fontWeight: '400',
    boxShadow: '0 8px 32px rgba(139, 42, 42, 0.3), inset 0 1px 0 rgba(229, 220, 200, 0.2)',
    position: 'relative',
  },
  closeButton: {
    position: 'absolute',
