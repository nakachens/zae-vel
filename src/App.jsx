...
function Desktop({ apps, onOpenApp }) {
  ...
  return (
    ...
    >
      ...
      <DraggableWidget widgetId="calendar" initialPosition={{ x: window.innerWidth - 200, y: 120 }}>
        <CalendarWidget />
      </DraggableWidget>
      ...
      <DraggableWidget widgetId="goals" initialPosition={{ x: 780, y: 190 }}>
        <FocusGoalsWidget />
      </DraggableWidget>
...
function DesktopIcon({ app, onDoubleClick }) {
  return (
    <div
      className="flex flex-col items-center p-2 m-1 w-20 cursor-pointer rounded-lg transition-all duration-200"
